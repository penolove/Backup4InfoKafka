...
#ifndef BEJWRMSO2Z00TLK5MTY02ZK6TBAAZFQYL_H_
#define BEJWRMSO2Z00TLK5MTY02ZK6TBAAZFQYL_H_
...
#define SELF BeJwrMSo2z00tLk5MTy02zk6tBAAzFQYl
...
public:
    ...
    SELF() : Tuple(), message_(), key_() {}
    SELF(const Self & ot) : Tuple(), message_(ot.message_), key_(ot.key_) 
      { constructPayload(ot); }
    SELF(const message_type & _message, const key_type & _key) : Tuple(), message_(_message), key_(_key) { }
...
#undef SELF
#endif // BEJWRMSO2Z00TLK5MTY02ZK6TBAAZFQYL_H_ 
