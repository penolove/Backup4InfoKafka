...
#ifndef BEJWRMSOXKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTPDG0JZEPNQCAJH4UAW_H_
#define BEJWRMSOXKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTPDG0JZEPNQCAJH4UAW_H_
...
public:
    ...
    SELF() : Tuple(), flowID_(), label_() {}
    SELF(const Self & ot) : Tuple(), flowID_(ot.flowID_), label_(ot.label_) 
      { constructPayload(ot); }
    SELF(const flowID_type & _flowID, const label_type & _label) : Tuple(), flowID_(_flowID), label_(_label) { }
...
#undef SELF
#endif // BEJWRMSOXKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTPDG0JZEPNQCAJH4UAW_H_ 
