// t2t4s7srcAddrK7srcPorts7dstAddrK7dstPort6flowIDmsF8features


#ifndef BEJWRMSOXKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTJBFYZSITNBGKTCI1GACRDBZF_H_
#define BEJWRMSOXKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTJBFYZSITNBGKTCI1GACRDBZF_H_
...
#define SELF BeJwrMSoxKTYvLkp2TEkp8gYxAvKLSorNU4pLICJABkjELC0nv9zTJbfYzSItNbGktCi1GACRDBZF
...
public:
    ...
    typedef SPL::map<SPL::rstring, SPL::float64 > features_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), flowID_(), features_() {}
    SELF(const Self & ot) : Tuple(), flowID_(ot.flowID_), features_(ot.features_) 
      { constructPayload(ot); }
    SELF(const flowID_type & _flowID, const features_type & _features) : Tuple(), flowID_(_flowID), features_(_features) { }
    ...
    features_type & get_features() { return features_; }
    const features_type & get_features() const { return features_; }
    void set_features(const features_type & _features) { features_ = _features; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<features_type >()(features_);
        return s;
    }
   ...
   size += features_.getSerializedSize();
    ...
    { 
        ...
        std::swap(features_, ot.features_);
...
#undef SELF
#endif // BEJWRMSOXKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTJBFYZSITNBGKTCI1GACRDBZF_H_ 
