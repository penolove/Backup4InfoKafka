...
#ifndef BEJWRMSW2ZCNMSY0GABBPANP_H_
#define BEJWRMSW2ZCNMSY0GABBPANP_H_
...
#define SELF BeJwrMSw2zcnMSy0GABBPANp
...
public:
    ...
    typedef SPL::rstring lines_type;

    enum { num_attributes = 1 } ;
    
    SELF() : Tuple(), lines_() {}
    SELF(const Self & ot) : Tuple(), lines_(ot.lines_) 
      { constructPayload(ot); }
    SELF(const lines_type & _lines) : Tuple(), lines_(_lines) { }
...
#undef SELF
#endif // BEJWRMSW2ZCNMSY0GABBPANP_H_ 
