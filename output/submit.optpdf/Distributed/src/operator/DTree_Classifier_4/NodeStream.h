...
#ifndef SPL_OPER_INSTANCE_DTREE_CLASSIFIER_4_NODESTREAM_H_
#define SPL_OPER_INSTANCE_DTREE_CLASSIFIER_4_NODESTREAM_H_
...
#undef MY_OPERATOR
#endif // SPL_OPER_INSTANCE_DTREE_CLASSIFIER_4_NODESTREAM_H_
