// t2s3keyt1s7timeend4data


#ifndef BEJWRMSO2ZK6TLDESNI_1JZE1NZUSXSUKSSQQAZCYICZ_H_
#define BEJWRMSO2ZK6TLDESNI_1JZE1NZUSXSUKSSQQAZCYICZ_H_
...
#define SELF BeJwrMSo2zk6tLDEsNi_1JzE1NzUsxSUksSQQAZcYICZ
...
public:
    ...
    typedef SPL::BeJwrMSw2L8nMTU3NSwEAGHoEA2 data_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), key_(), data_() {}
    SELF(const Self & ot) : Tuple(), key_(ot.key_), data_(ot.data_) 
      { constructPayload(ot); }
    SELF(const key_type & _key, const data_type & _data) : Tuple(), key_(_key), data_(_data) { }
...
#undef SELF
#endif // BEJWRMSO2ZK6TLDESNI_1JZE1NZUSXSUKSSQQAZCYICZ_H_ 
