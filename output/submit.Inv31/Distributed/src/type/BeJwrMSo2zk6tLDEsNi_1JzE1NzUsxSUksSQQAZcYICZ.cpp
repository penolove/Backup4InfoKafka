...
#include "BeJwrMSo2zk6tLDEsNi_1JzE1NzUsxSUksSQQAZcYICZ.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring key,tuple<rstring timeend> data>",&initer));
...
#define MY_OFFSETOF(member, base) \
    ...
    
    {
        ...
        TypeOffset t(MY_OFFSETOF(data_, tm), 
                     Meta::Type::typeOf<SPL::BeJwrMSw2L8nMTU3NSwEAGHoEA2 >(), 
                     &typeid(SPL::BeJwrMSw2L8nMTU3NSwEAGHoEA2));
        addMapping(*tm, t, s, 1);
    }
