...
#ifndef BEJWRMSO1Y8TPSFV0KTBNSUXKZQEANSWGAT_H_
#define BEJWRMSO1Y8TPSFV0KTBNSUXKZQEANSWGAT_H_
...
public:
    ...
    SELF() : Tuple(), nodeID_(), label_() {}
    SELF(const Self & ot) : Tuple(), nodeID_(ot.nodeID_), label_(ot.label_) 
      { constructPayload(ot); }
    SELF(const nodeID_type & _nodeID, const label_type & _label) : Tuple(), nodeID_(_nodeID), label_(_label) { }
...
#undef SELF
#endif // BEJWRMSO1Y8TPSFV0KTBNSUXKZQEANSWGAT_H_ 
