...
#ifndef BEJWRMS4XKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTJBFYZSITNBGKTCI1UNJI0WUA7ZYXB4_H_
#define BEJWRMS4XKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTJBFYZSITNBGKTCI1UNJI0WUA7ZYXB4_H_
...
public:
    ...
    typedef SPL::rstring ID_type;

    enum { num_attributes = 3 } ;
    
    SELF() : Tuple(), flowID_(), features_(), ID_() {}
    SELF(const Self & ot) : Tuple(), flowID_(ot.flowID_), features_(ot.features_), ID_(ot.ID_) 
      { constructPayload(ot); }
    SELF(const flowID_type & _flowID, const features_type & _features, const ID_type & _ID) : Tuple(), flowID_(_flowID), features_(_features), ID_(_ID) { }
...
#undef SELF
#endif // BEJWRMS4XKTYVLKP2TEKP8GYXAVKLSORNU4PLICJABKJELC0NV9ZTJBFYZSITNBGKTCI1UNJI0WUA7ZYXB4_H_ 
