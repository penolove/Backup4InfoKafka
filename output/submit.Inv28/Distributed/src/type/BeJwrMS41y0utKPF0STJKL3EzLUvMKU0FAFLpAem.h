// t3u6nextIDb2gtF5value


#ifndef BEJWRMS41Y0UTKPF0STJKL3EZLUVMKU0FAFLPAEM_H_
#define BEJWRMS41Y0UTKPF0STJKL3EZLUVMKU0FAFLPAEM_H_
...
#define SELF BeJwrMS41y0utKPF0STJKL3EzLUvMKU0FAFLpAem
...
public:
    ...
    SELF() : Tuple(), nextID_(), gt_(), value_() {}
    SELF(const Self & ot) : Tuple(), nextID_(ot.nextID_), gt_(ot.gt_), value_(ot.value_) 
      { constructPayload(ot); }
    SELF(const nextID_type & _nextID, const gt_type & _gt, const value_type & _value) : Tuple(), nextID_(_nextID), gt_(_gt), value_(_value) { }
    ...
    {
        size_t size = sizeof(SPL::uint32)+sizeof(SPL::boolean)+sizeof(SPL::float64);
...
#undef SELF
#endif // BEJWRMS41Y0UTKPF0STJKL3EZLUVMKU0FAFLPAEM_H_ 
